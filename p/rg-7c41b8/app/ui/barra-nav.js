/* ═══════════════════════════════════════════════════════════════════
   ...
   L'anatomia di iOS, quella vera: 44 punti di barra piu' la safe-area,
   e sotto 52 punti di titolo grande in Bodoni 34. Si scorre, il titolo
   grande esce e quello compatto entra — Inter 600 a 17.

   Perche' una DISSOLVENZA INCROCIATA e non un titolo che rimpicciolisce:
   ...
   stessa larghezza. Un morphing fra i due e' una terza cosa sbagliata
   ...
   indietro — che e' esattamente cio' che fa una UINavigationController.
   ═══════════════════════════════════════════════════════════════════ */
...
/* ── L'INCROCIO ────────────────────────────────────────────────────
   ...
   La soglia e' il punto in cui il titolo grande finisce di passare
   dietro la barra — non un numero fisso: un titolo su due righe ha una
   soglia diversa, e un numero fisso lo scoprirebbe tardi.
   Il listener e' passivo e strozzato a un fotogramma: lo scroll di un
